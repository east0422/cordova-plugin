...
//                                 Log.e(TAG, "1111 Couldn't establish a Bluetooth connection.", e1);
//                                 try {
//                                     mmSocket.close();
//                                 } catch (IOException e3) {
//                                     Log.e(TAG, "1111 unable to close() " + mSocketType + " socket during connection failure", e3);
//                                 }
//                                 connectionFailed();
//                                 return;
//                             }
...
//                     }).start();
//                 } catch (Exception e2) {
//                     Log.e(TAG, "aaaa Couldn't establish a Bluetooth connection.", e2);
//                     try {
//                         mmSocket.close();
//                     } catch (IOException e3) {
//                         Log.e(TAG, "aaaa unable to close() " + mSocketType + " socket during connection failure", e3);
//                     }
//                     connectionFailed();
//                     return;
//                 }
